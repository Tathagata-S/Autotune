...
We illustrate autotune lasso on simulated data using a linear model with $s=5$, $n=250$, $p=500$. Reader can also specify different configurations of data generating process in the following code chunk.
