...
```{r}
real_life_prediction_comparison <- function(x, y, x_test, y_test, alpha = 0.01, beta_iter_max = 40){

ans_autotune <- autotune_lasso(x, y, alpha = alpha, beta_iter_max = beta_iter_max, trace_it = TRUE)
...
# Plot training error from cross-validation (cv_fit)
plot(cv_fit,
...
# Add vertical guideline bars and labels
...
# === Add error bars for training errors ===
